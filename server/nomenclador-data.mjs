export const americanCountries = [
  ...
  "Estados Unidos", "Granada", "Guatemala", "Guyana", "Haiti", "Honduras", "Jamaica", "Mexico",
  "Nicaragua", "Panama", "Paraguay", "Peru", "Republica Dominicana", "San Cristobal y Nieves",
...
export const provincesByCountry = {
  ...
  "Estados Unidos": [
    ...
    "Montana", "Nebraska", "Nevada", "Nueva Hampshire", "Nueva Jersey", "Nuevo Mexico", "Nueva York",
    "Carolina del Norte", "Dakota del Norte", "Ohio", "Oklahoma", "Oregon", "Pensilvania",
    "Rhode Island", "Carolina del Sur", "Dakota del Sur", "Tennessee", "Texas", "Utah", "Vermont",
    "Virginia", "Washington", "Virginia Occidental", "Wisconsin", "Wyoming", "Distrito de Columbia"
  ],
  Venezuela: [
  ...
  Ecuador: [
    ...
    "Orellana", "Pastaza", "Pichincha", "Santa Elena", "Santo Domingo de los Tsachilas",
  ...
  Argentina: [
    ...
    "Tierra del Fuego", "Tucuman", "Ciudad Autonoma de Buenos Aires"
  ],
  Chile: [
    ...
    "Biobio", "La Araucania", "Los Rios", "Los Lagos", "Aysen", "Magallanes y de la Antartica Chilena"
  ],
  ...
  Nicaragua: [
    ...
    "Madriz", "Managua", "Masaya", "Matagalpa", "Nueva Segovia", "Rio San Juan", "Rivas",
    "Costa Caribe Norte", "Costa Caribe Sur"
  ],
  Panama: [
    "Bocas del Toro", "Chiriqui", "Cocle", "Colon", "Darien", "Herrera", "Los Santos", "Panama",
    "Panama Oeste", "Veraguas", "Guna Yala", "Embera", "Ngäbe-Bugle"
  ],
  Guatemala: [
  ...
  "El Salvador": [
    "Ahuachapan", "Cabañas", "Chalatenango", "Cuscatlan", "La Libertad", "La Paz", "La Union",
    "Morazan", "San Miguel", "San Salvador", "San Vicente", "Santa Ana", "Sonsonate", "Usulutan"
  ],
  Belice: ["Belize", "Cayo", "Corozal", "Orange Walk", "Stann Creek", "Toledo"],
  Canada: [
    "Alberta", "Columbia Britanica", "Manitoba", "Nuevo Brunswick", "Terranova y Labrador",
    "Nueva Escocia", "Ontario", "Isla del Principe Eduardo", "Quebec", "Saskatchewan",
    "Territorios del Noroeste", "Nunavut", "Yukon"
  ],
  Cuba: [
    "Pinar del Rio", "Artemisa", "La Habana", "Mayabeque", "Matanzas", "Cienfuegos", "Villa Clara",
    "Sancti Spiritus", "Ciego de Avila", "Camaguey", "Las Tunas", "Holguin", "Granma",
    "Santiago de Cuba", "Guantanamo", "Isla de la Juventud"
  ],
  "Republica Dominicana": [
    "Azua", "Bahoruco", "Barahona", "Dajabon", "Distrito Nacional", "Duarte", "El Seibo",
    "Elias Piña", "Espaillat", "Hato Mayor", "Hermanas Mirabal", "Independencia", "La Altagracia",
    "La Romana", "La Vega", "Maria Trinidad Sanchez", "Monseñor Nouel", "Monte Cristi",
    "Monte Plata", "Pedernales", "Peravia", "Puerto Plata", "Samana", "San Cristobal",
    "San Jose de Ocoa", "San Juan", "San Pedro de Macoris", "Sanchez Ramirez", "Santiago",
  ...
  Paraguay: [
    "Concepcion", "San Pedro", "Cordillera", "Guaira", "Caaguazu", "Caazapa", "Itapua",
    "Misiones", "Paraguari", "Alto Parana", "Central", "Ñeembucu", "Amambay", "Canindeyu",
    "Presidente Hayes", "Boqueron", "Alto Paraguay", "Asuncion"
  ],
  Guyana: [
  ...
  Jamaica: [
    "Kingston", "Saint Andrew", "Saint Thomas", "Portland", "Saint Mary", "Saint Ann", "Trelawny",
    "Saint James", "Hanover", "Westmoreland", "Saint Elizabeth", "Manchester", "Clarendon", "Saint Catherine"
  ],
  "Trinidad y Tobago": [
    "Port of Spain", "San Fernando", "Arima", "Chaguanas", "Point Fortin", "Couva-Tabaquite-Talparo",
    "Diego Martin", "Mayaro-Rio Claro", "Penal-Debe", "Princes Town", "San Juan-Laventille",
    "Sangre Grande", "Siparia", "Tunapuna-Piarco", "Tobago"
  ],
  Bahamas: [
    "Nueva Providencia", "Gran Bahama", "Abaco", "Andros", "Bimini", "Cat Island", "Eleuthera",
    "Exuma", "Inagua", "Long Island", "Mayaguana", "Ragged Island", "San Salvador", "Berry Islands",
  ...
  "Antigua y Barbuda": ["Saint George", "Saint John", "Saint Mary", "Saint Paul", "Saint Peter", "Saint Philip", "Barbuda", "Redonda"],
  Dominica: [
    "Saint Andrew", "Saint David", "Saint George", "Saint John", "Saint Joseph", "Saint Luke",
    "Saint Mark", "Saint Patrick", "Saint Paul", "Saint Peter"
  ],
  Granada: ["Saint Andrew", "Saint David", "Saint George", "Saint John", "Saint Mark", "Saint Patrick", "Carriacou y Petite Martinique"],
  ...
  "San Vicente y las Granadinas": ["Charlotte", "Saint Andrew", "Saint David", "Saint George", "Saint Patrick", "Granadinas"],
  "Santa Lucia": ["Anse la Raye", "Canaries", "Castries", "Choiseul", "Dennery", "Gros Islet", "Laborie", "Micoud", "Soufriere", "Vieux Fort"]
};

export const nomenclatorDefaults = {
  account_type: ["Customer", "Prospect", "Integrator", "Competitor"],
  product_type: [
    "Foil", "Tricapa", "Pouch", "Tapas", "PVDC", "Vasos", "Lam_Pharma", "Good", "Laminado",
    "Alu_Alu", "Sobre_Multi_Usos", "Policromia", "Sin_Impresion", "1Tinta", "2Tintas", "3Tintas"
  ],
  department: ["COMPRAS", "CALIDAD", "TESORERIA", "GERENCIA", "PRODUCCION", "LOGISTICA", "MERCADEO", "CONTABILIDAD", "DISENO", "SUMINISTROS", "DESPACHOS"],
...
export const nomenclatorCategories = [
  ...
  { id: "diseno_status", label: "Estados de diseno" },
  { id: "iva_rate", label: "Tarifas de IVA" }
];
